...
def set_taborder(self):
    ...
    self.setTabOrder(self.cmtTiedot, self.cmtTulosyy)
    self.setTabOrder(self.cmtTulosyy, self.cmtTestTulokset)
    self.setTabOrder(self.cmtTestTulokset, self.cmtKavelyTulokset)
    self.setTabOrder(self.cmtKavelyTulokset, self.cmtSuunnitelma)
    self.setTabOrder(self.cmtSuunnitelma, self.cmtAntrop)
